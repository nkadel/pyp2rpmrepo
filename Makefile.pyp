...
# Some RHEL dependencies are supplied locally in repo
# Disabled, RHEL 6 is now obsolete
MOCKS+=pyprepo-8-x86_64
MOCKS+=pyprepo-9-x86_64

MOCKCFGS+=$(MOCKS)

# Local yum compatible RPM repository
REPOBASEDIR="`/bin/pwd | xargs dirname`/pyprepo"
...
install:: $(MOCKS)
	@for repo in $(MOCKS); do \
		...
		*-38-x86_64) yumrelease=fedora/37; yumarch=x86_64; ;; \
		*-f38-x86_64) yumrelease=fedora/37; yumarch=x86_64; ;; \
